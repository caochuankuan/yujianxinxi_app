...
import 'package:yifeng_site/services/moyu_rili_api.dart';

// 摸鱼日历页面部件
class MoyuRiliPage extends StatefulWidget {
  const MoyuRiliPage({super.key});
  ...
  Future<void> _selectDate(BuildContext context) async {
    ...
    if (picked != null && picked != selectedDate) {
      setState(() {
        ...
        _futureImageUrl = Future.value('https://dayu.qqsuu.cn/moyurili/file/$formattedDate.png');
      });
    }
  }
